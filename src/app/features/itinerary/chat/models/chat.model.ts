...
/**
 * Payload for sending a message (without type - determined by endpoint)
 */
...
/**
 * Payload for editing a message (without type - determined by endpoint)
 */
...
/**
 * Payload for deleting a message (without type - determined by endpoint)
 */
...
/**
 * Payload for typing indicator (without type - determined by endpoint)
 */
